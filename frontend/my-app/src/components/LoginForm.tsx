        ...
        <div className="hidden lg:flex lg:w-1/2 bg-black text-white p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Welcome Back to<br />Your Second Brain
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed max-w-md">
              Access your intelligent knowledge base and continue your productivity journey.
            </p>
          </div>
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Your data is encrypted and protected with enterprise-grade security.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">Access your notes from anywhere, anytime, on any device.</p>
              </div>
            </div>
          </div>
