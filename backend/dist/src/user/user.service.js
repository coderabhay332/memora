...
exports.getMe = exports.generateRefreshToken = exports.getUserByEmail = exports.getUserById = exports.createUser = void 0;
...
const getMe = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_schema_1.default.findById(userId).select('-password').lean();
    return user;
});
exports.getMe = getMe;
